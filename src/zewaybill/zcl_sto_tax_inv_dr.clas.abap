...
*                  company_code     TYPE string
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS lc_template_name TYPE string VALUE 'zsd_bs_tax_invoice/zsd_bs_tax_invoice'."'zpo/zpo_v2'."
...
************************************************************************************
    ...
    select single from ZR_Gateentryheader as a
    fields a~Vehicleno, a~Lrno, a~Transportmode      " Lrdate
    where a~Gateentryno = @wa_gateno-gateentryno
